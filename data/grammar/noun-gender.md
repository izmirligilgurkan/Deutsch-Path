...
sourcePage: German/Grammar/Noun gender
sourceUrl: "https://en.wikibooks.org/wiki/German/Grammar/Noun_gender"
sourceRevision: 4408412
...
#### What to look for in a gender rule
...
- People having certain occupations *Lehrer*, m ("male teacher"); *Lehrerin*, f ("female teacher"); *Arzt*, m ("male doctor"); *Ärztin*, f ("female doctor") Note that German adds the feminine suffix *-in* for females so the gender is built into the word.
...
- [Lingolia: Genus](https://deutsch.lingolia.com/de/grammatik/substantive/genus)
