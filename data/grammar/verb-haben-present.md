---
id: verb-haben-present
title: haben in the present tense
level: A1
units: [2]
stub: false
source: "Wikibooks: German"
sourcePage: German/Grammar/Irregular verbs
sourceUrl: "https://en.wikibooks.org/wiki/German/Grammar/Irregular_verbs"
sourceRevision: 4610927
...
Once you eliminate stem-changing verbs, German has surprisingly few verbs that are irregular in the present tense, and we'll increase our inventory of verbs a bit by introducing many of them here. We'll postpone the rest until we cover a bit more grammar and can use them as they're meant to be used. These include *sein* ("to be") and *werden* ("to become"), which will be covered in the next section, and some of the past-like present verbs (defined below).

#### tun

Traditionally, German textbooks in English tend to postpone introducing this verb long past where should be, given that it is so common. This is understandable since it's a cognate to the English "do", and while it can often be used the same way, it's use in German is much more restricted than it is in English. So, rather than have students using *tun* inappropriately, textbook authors apparently have chosen to not tell readers about it until they've reached some mastery of other aspects of the language.
...
- *Ich habe einen Hund.* – "I have a dog."
  - Note that *haben* is a transitive verb and uses the accusative case for *einen Hund*.
...
- [Lingolia: sein und haben](https://deutsch.lingolia.com/de/grammatik/verben/sein-haben)
