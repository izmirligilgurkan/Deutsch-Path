...
sourcePage: German/Grammar/Pronomial possessives
sourceUrl: "https://en.wikibooks.org/wiki/German/Grammar/Pronomial_possessives"
sourceRevision: 4072269
...
Second, possessive pronouns replace the nouns themselves, as with personal pronouns, but they indicate possession as well. So, in English, while "my" and "our" are possessive determiners, "mine" and "ours" are possessive pronouns, as in "Mine is red," or "Ours is big."

Unlike English, where there is a noticeable difference between the words used as possessive determiners and possessive pronouns, in German the differences are very minor and you must use their position in a sentence to tell them apart. Since German is a more highly inflected than English, all of these words must be declined. Fortunately, the way this is done is very logical and can be derived from the personal pronouns and articles.

#### Forming possessive determiners
...
The only irregularity you may encounter with this system is that the letters *-ere-* are often slurred in spoken German, especially in informal or colloquial speech. So you'll often hear *unsern* instead of *unseren*, and when this is recorded in writing you may see it spelled this way too. Another possibility, *unsren*, exists but it seems to be limited to poetry for the most part. If the *e* is at the end of the word then it's never dropped because it's needed to tell which inflection is being used. This is carried further with *euer-*, so *euere* and *eueren* are almost universally replaced by *eure* and *euren*.
...
- [Lingolia: Possessivpronomen](https://deutsch.lingolia.com/de/grammatik/pronomen/possessivpronomen)
