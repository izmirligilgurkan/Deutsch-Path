...
sourcePage: German/Grammar/Adjectives and Adverbs
sourceUrl: "https://en.wikibooks.org/wiki/German/Grammar/Adjectives_and_Adverbs"
sourceRevision: 4027520
...
> Example of an attributive adjective: Der große Mann ist lustig. The tall man is funny.
...
> Example of a predicative adjective: Der große Mann ist lustig. The tall man is funny.
...
> Another example of a predicative adjective using the adjective groß: Der Mann ist groß. The man is tall.
...
> Example of an adverbial adjective: Der große Mann läuft gut. The tall man runs well.
...
| **Nominative** | de**r** groß**e** Mann | da**s** klein**e** Buch | di**e** ruhig**e** Katze | di**e** rot**en** Äpfel |
| **Accusative** | de**n** groß**en** Mann |  |  |  |
| **Dative** | de**m** groß**en** Mann | de**m** klein**en** Buch | de**r** ruhig**en** Katze | de**n** rot**en** Äpfel**n** |
| **Genitive** | de**s** groß**en** Mann**es** | de**s** klein**en** Buch**es** |  | de**r** rot**en** Äpfel |


## Further reading

- [Lingolia: Steigerung](https://deutsch.lingolia.com/de/grammatik/adjektive/steigerung)
