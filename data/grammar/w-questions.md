...
sourcePage: German/Grammar/Interrogatives
sourceUrl: "https://en.wikibooks.org/wiki/German/Grammar/Interrogatives"
sourceRevision: 4073338
...
The words *wieso* and *weshalb* are roughly synonymous. But *warum* tends to be used in situations where the speaker wants to know the logical cause or what incited the action. Meanwhile *wieso* might be used when a physical cause needs to be understood, and *weshalb* is asking more for a purpose or goal for the action. Of the three, *warum* is the most common and you can take it for the default translation of "why" if there's any doubt.
...
- [Lingolia: Fragen](https://deutsch.lingolia.com/de/grammatik/satzbau/fragen)
