---
id: subordinate-clauses-extended
title: Subordinate clauses, extended
level: B1
units: [30]
stub: false
source: "Wikibooks: German"
sourcePage: German/Grammar/Subordinating conjunctions
sourceUrl: "https://en.wikibooks.org/wiki/German/Grammar/Subordinating_conjunctions"
sourceRevision: 4282242
...
- *als*: This can often be translated as "as", meaning while a specific event occurred in the past.
  - *Ich wusste es, als ich dich das erste Mal sah.* – "I knew it the first time I saw you."
- *wenn*: This can often be translated as "when", meaning while a specific event occurs in the present or future. Do not confuse this with *wann*, the question word which can also be translated as "when".
  - *Wir werden essen, wenn das Abendessen fertig ist.* – "We will eat when dinner is ready."

It's also used for ongoing events. In this sense it can be translated as "while": *Wir wandern oft, wenn das Wetter schön ist.* – "We often hike when the weather is nice."

It can also be translated as "if", meaning when a certain condition is met. *Ich werde gewinnen, wenn ich stark bin.* – "I will win if I'm strong."

- *während*: This means "while"; it overlaps in meaning with *wenn*.
  - *Ich muss Abendessen kochen, während mein Mann weg ist.* – "I must cook dinner while my husband is away."
...
- [Lingolia: Nebensatz](https://deutsch.lingolia.com/de/grammatik/satzbau/nebensatz)
